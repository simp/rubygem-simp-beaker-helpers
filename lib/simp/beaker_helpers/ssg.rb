  ...
  class SSG
    ...
    def get_ssg_datastream
      ...
      if ssg_release
        ...
        on(@sut, %(cd scap-content/build-scripts; sed -e 's/ssg.build_derivatives.profile_handling/__simp_dontcare__ = None #ssg.build_derivatives.profile_handling/g' enable_derivatives.py 1<> enable_derivatives.py))
